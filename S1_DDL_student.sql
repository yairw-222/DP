...
--relation "mederwerkers" does not exist
...
INSERT INTO medewerkers(mnr,naam,voorl,gbdatum,maandsal,afd,geslacht)
VALUES(9000,'ADRIAAN DONK','A','1989-06-17',3000,10,'M');
INSERT INTO afdelingen(anr,naam,locatie)
VALUES(20,'ONDERZOEK','ZWOLLE')
--
...
(
    postcode   		VARCHAR(6) CONSTRAINT postcode_regexp CHECK (postcode ~ $$^([0-9]{4})((\s)*([a-zA-Z]{2}))$$),
...
ALTER TABLE medewerkers
	ADD CONSTRAINT m_comm_chk CHECK(functie='VERKOPER');
